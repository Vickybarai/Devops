...
✔ Image now available globally ✔ Others can pull it ✔ Ready for deployment
...
✔ Dockerfile present ✔ Image built ✔ Correct tag format ✔ Logged in ✔ Repository exists on Hub ✔ Push command uses full name
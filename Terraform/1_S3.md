...
├── variables.tf      # Input Variables (Bucket Name, Tags, etc.)
├── iam.tf            # IAM Users, Groups, and Attachments
├── s3.tf             # S3 Bucket, Hosting Config, and Upload
└── outputs.tf        # Website URL and User Info
```

---


# 🌐 Project: IAM Identity Management & S3 Static Website

...
**Definition:**  
Amazon Elastic Kubernetes Service (EKS) is a fully managed Kubernetes service by AWS service by AWS that handles all **control plane components** for you.
...
2. Provide:
   ...
   - **VPC & Subnets** Subnets** (existing/default)
...
4. Nodes automatically join the cluster
